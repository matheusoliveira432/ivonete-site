/**
 * =================================================================
   HAIR STYLIST - PAINEL ADMINISTRATIVO
...
class AdminPanel {
    ...
    generateScheduleTable() {
        ...
        hours.forEach(hour => {
            ...
            // Colunas dos dias da semana (Terça a Sábado - 5 dias)
    ...
    populateScheduleTable() {
        ...
        this.appointments.forEach(appointment => {
            ...
            const cell = document.querySelector(`[data-day="${dayIndex + 2}"][data-hour="${appointment.horario}"]`);
            if (!cell) {
    ...
    markAsCompleted() {
        ...
        this.markAsComplete(this.selectedAppointment.id);
    }
    ...
    updateWeekDisplay() {
        ...
        const endDate = weekDates[4]; // Sábado (índice 4) - último dia da semana
    ...
    getWeekDates(weekOffset = 0) {
        try {
            ...
            const weekDates = [];
            for (let i = 1; i < 6; i++) { // Apenas 5 dias: Terça a Sábado
